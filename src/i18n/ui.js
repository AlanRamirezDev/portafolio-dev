export const languages = {
  ...
  export const ui = {
    ...
    en: {
      'hero.profileBadge': 'Professional Profile',
      'hero.greeting': 'Hello! I am',
      'hero.role': 'Computer Engineer | Full Stack Developer',
      'hero.description': 'Specialized in high-performance scalable architectures. I translate complex business logic into resilient platforms, prioritizing safe concurrency, clean code, and fault tolerance from local development to production deployment, including quality testing.',
